...
// Overview (Control plane), Cases and Review are wired to real data (see
// Data.jsx + the real-data edits in Overview.jsx/Review.jsx themselves).
// Reliability, Audit and Scenario are still copied into frontend/ but left
// out of navigation and out of index.html's script tags -- their JSX leans
// on fixture-only concepts (a multi-region executor fleet, a fixed
// narrative script) that don't correspond to anything real in this backend.
const SURFACES = [
